...
export class MenusComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.routeItems = [
            { label: 'Datos Generales', routerLink: 'personal' },
            { label: 'Contacto de Emergencia', routerLink: 'contacto' },
            { label: 'Datos Médicos', routerLink: 'medicos' },
            { label: 'Finalizar Registro', routerLink: 'finalizar' },
        ];
